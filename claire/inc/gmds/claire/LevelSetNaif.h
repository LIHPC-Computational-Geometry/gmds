...
#ifndef GMDS_LEVELSETNAIF_H
#define GMDS_LEVELSETNAIF_H
...
namespace gmds {
/*----------------------------------------------------------------------------*/
class LIB_GMDS_CLAIRE_API LevelSetNaif
{
 public:
	/*--------------------------------------------------------------------*/
	 ...
	 */
	LevelSetNaif(Mesh *AMesh, int AmarkFrontNodes);
