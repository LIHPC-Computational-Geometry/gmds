...
double HexQuality::edgeRatioModified() const{
	...
	ratio0 = std::min(l0(),l2())/std::max(l0(),l2());
	ratio1 = std::min(l1(),l3())/std::max(l1(),l3());
	ratio2 = std::min(l0(),l8())/std::max(l0(),l8());
	ratio3 = std::min(l1(),l9())/std::max(l1(),l9());
	ratio4 = std::min(l2(),l10())/std::max(l2(),l10());
	ratio5 = std::min(l3(),l11())/std::max(l3(),l11());
	ratio6 = std::min(l8(),l10())/std::max(l8(),l10());
	ratio7 = std::min(l9(),l11())/std::max(l9(),l11());
