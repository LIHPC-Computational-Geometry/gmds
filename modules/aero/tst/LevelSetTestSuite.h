...
#include <gmds/aero/LevelSetEloi.h>
#include <gmds/aero/LevelSetExtended.h>
#include <gmds/aero/LevelSetCombined.h>
#include <gmds/aero/GradientComputation_2D.h>
...
TEST(LevelSetTestClass, DISABLED_LevelSet_Apollo_TEST)
{
...
TEST(LevelSetTestClass, DISABLED_MFEM_Test)
{
	// Mesh
	Mesh m(gmds::MeshModel(gmds::DIM3 | gmds::F | gmds::N | gmds::E | gmds::N2E | gmds::N2F | gmds::F2N | gmds::E2N | gmds::F2E | gmds::E2F));
	std::string dir(TEST_SAMPLES_DIR);
