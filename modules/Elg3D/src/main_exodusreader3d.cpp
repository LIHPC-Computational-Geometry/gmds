...
//    const double xyz_min[3] = {-1., -1., -20.};
//    const double xyz_max[3] = {25., 14., 1.};
//    const int ni = 24;
//    const int nj = 13;
//    const int nk = 20;
    ...
    elg3d::initData_fromExodus_3D(&mesh, &fp, case_filename, xyz_min, xyz_max, ni, nj, nk, fill_void);

//    std::ofstream myfile;
//    myfile.open ("volfrac.txt");
//
//    const int nbRegions_tmp = mesh.getNbRegions();
//    const int nbMat_tmp = fp.getNbMaterials();
//
//    for(int i=0; i<nbRegions_tmp; i++) {
//        for(int imat=0; imat<nbMat_tmp; imat++) {
//            myfile << fp.getFracPres(imat, i) << std::endl;
//        }
//    }
//    myfile.close();
//    exit(-1);

//    elg3d::initData_internalFormat(&mesh, &fp, "Elg3D/test/Samples/internalFormat_3x3x3_2mat_2_3D.txt");
