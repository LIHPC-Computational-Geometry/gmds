...
/*----------------------------------------------------------------------------*/
LimaWriterStreamMli2::LimaWriterStreamMli2(Mesh& AMesh)
  : m_mesh(AMesh), m_length_unit(1.), m_writer(nullptr)
{}
/*----------------------------------------------------------------------------*/
LimaWriterStreamMli2::~LimaWriterStreamMli2()= default;
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::setLengthUnit(double AUnit)
{
	m_length_unit = AUnit;
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::activateZlibCompression()
{
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::write(const std::string& AFileName, MeshModel AModel, int ACompact)
{
	try {
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::checkContinuousNodes(){
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::checkContinuousEdges(){
	bool isContiguous = true;
	TCellID minID = NullID;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::checkContinuousFaces(){
	bool isContiguous = true;
	TCellID minID = NullID;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::checkContinuousRegions(){
	bool isContiguous = true;
	TCellID minID = NullID;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeNodes() {
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeEdges() {
	// check whether the ids are contiguous
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeFaces() {
	// check whether the ids are contiguous
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeRegions(){
	// check whether the ids are contiguous
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeClouds() {
	const Lima::id_type LimaWriterAPI_NBNODES_CHUNK = 10000;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeLines() {
	const Lima::id_type LimaWriterAPI_NBEDGES_CHUNK = 10000;
	std::vector<std::string> names;
	std::vector<Lima::id_type> sizes;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeSurfaces() {
	const Lima::id_type LimaWriterAPI_NBFACES_CHUNK = 10000;
	std::vector<std::string> names;
	std::vector<Lima::id_type> sizes;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeVolumes() {
	const Lima::id_type LimaWriterAPI_NBREGIONS_CHUNK = 10000;
	std::vector<std::string> names;
	std::vector<Lima::id_type> sizes;
...
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeNodesAttributes() {
	m_writer->writeNodeAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeEdgesAttributes() {
	m_writer->writeEdgeAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeFacesAttributes(){
	m_writer->writeFaceAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeRegionsAttributes(){
	m_writer->writeRegionAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeCloudsAttributes(){
	m_writer->writeNodeSetsAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeLinesAttributes(){
	m_writer->writeEdgeSetsAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeSurfacesAttributes(){
	m_writer->writeFaceSetsAttributes();
}
/*----------------------------------------------------------------------------*/
void
LimaWriterStreamMli2::writeVolumesAttributes(){
