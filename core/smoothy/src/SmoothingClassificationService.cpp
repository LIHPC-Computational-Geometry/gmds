...
/*----------------------------------------------------------------------------*/
SmoothingClassificationService::SmoothingClassificationService(GeomMeshLinker* ALinker)
:m_linker(ALinker)
{
    init();
}
/*----------------------------------------------------------------------------*/
bool SmoothingClassificationService::isValidForClassification() const
{
...
/*----------------------------------------------------------------------------*/
void SmoothingClassificationService::init() {
