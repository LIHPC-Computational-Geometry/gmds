//
// Created by rochec on 25/01/2022.
//
...
/*-------------------------------------------------------------------*/
void
LevelSetNaif::initialisationDistances(){
...
/*-------------------------------------------------------------------*/
void
LevelSetNaif::getValue(TCellID n_id, double &v0){
...
/*-------------------------------------------------------------------*/
void
LevelSetNaif::setValue(TCellID n_id, double v0){
