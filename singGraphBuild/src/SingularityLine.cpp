...
{}
/*----------------------------------------------------------------------------*/
void SingularityLine::addSingularityPoint(SingularityPoint* APnt)
{
    if (m_points.size() >= 2)
...
/*----------------------------------------------------------------------------*/
void SingularityLine::addDiscretizationPoint(const gmds::math::Point& APnt){
    m_discretization_points.push_back(APnt);
}
/*----------------------------------------------------------------------------*/
void SingularityLine::setDiscretizationPoints(const std::vector<gmds::math::Point >& APoints)  {
...
/*----------------------------------------------------------------------------*/
void SurfaceSingularityLine::smooth(const int ANbStep)
{
...
/*----------------------------------------------------------------------------*/
std::vector<gmds::TCellID> SurfaceSingularityLine::getTraversedFaces() const
{
    return m_traversed_faces_id;
}
/*----------------------------------------------------------------------------*/
bool SurfaceSingularityLine::isTraversed(const gmds::TCellID AFaceID) const
{
...
/*----------------------------------------------------------------------------*/
gmds::math::Vector3d SingularityLine::getTangent(const double AParam) const
{
    ...
    if(AParam==0){
        ...
        gmds::math::Vector3d v1(m_discretization_points[m_discretization_points.size()-2],
                              m_discretization_points[m_discretization_points.size()-1]);
        gmds::math::Vector3d v2(m_discretization_points[m_discretization_points.size()-3],
...
/*----------------------------------------------------------------------------*/
void VolumeSingularityLine::smooth(const int ANbStep)
{
...
/*----------------------------------------------------------------------------*/
void SurfaceSingularityLine::setTraversedFaces(const std::vector<gmds::TCellID>& AIDs)
{
  m_traversed_faces_id = AIDs;
}
/*----------------------------------------------------------------------------*/
bool SurfaceSingularityLine::getIntersectionPoint( SurfaceSingularityLine* ALine, 
		      							...
		      							gmds::math::Point& APnt)
{
  ...
  for (unsigned int i = 1; i < m_discretization_points.size()-1; i++){     
    gmds::math::Point pi = m_discretization_points[i];
    gmds::math::Point pj = m_discretization_points[i+1];    
    if(ARefPnt.distance(pi)<=ARefRadius)
