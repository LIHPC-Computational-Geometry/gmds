...
/*----------------------------------------------------------------------------*/
TEST(BlockingClassifierTestSuite, simple_box)
{
...
/*----------------------------------------------------------------------------*/
TEST(BlockingClassifierTestSuite, b80)
{
	gmds::cad::FACManager geom_model;
...
TEST(BlockingClassifierTestSuite,ReturnErrors){
...
TEST(BlockingClassifierTestSuite,classifyFace){
    ...
    ASSERT_EQ(1,classifier.checkValidity(errors));
...
TEST(BlockingClassifierTestSuite,splitAndClassify){
...
TEST(BlockingClassifierTestSuite, testCurveBBox)
{
    gmds::cad::FACManager geom_model;
    set_up(&geom_model,"B80.vtk");
    gmds::mctsblock::Blocking bl(&geom_model,true);
...
TEST(BlockingClassifierTestSuite, testActionsList)
{
    gmds::cad::FACManager geom_model;
