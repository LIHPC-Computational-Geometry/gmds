...
\renewcommand\labelitemi{\includegraphics[scale=0.035]{item}}
...
%----------------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Singularity Graph Extraction}{name=strategies,column=0,below=pipeline, above=bottom}{
\noindent
\begin{minipage}[b]{1\linewidth}
\vspace{-0.1cm}\noindent
\begin{tcolorbox}[colframe=gray,boxrule=0.01pt,left=0mm,right=0mm,title=\Large $\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ $Objectives $\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ $Limitations$\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ $]		%\begin{itemize}
...
\captionof{figure}{\tiny a) "miss the connection"}
\label{fig:figure9}
%\vspace{-0.5cm}
\end{minipage}
\end{center}
...
%\noindent
%\begin{minipage}[!HT]{1.0\linewidth}
%\includegraphics[width=\textwidth]{all_poss_conn.png}
%\captionof{figure}{Get the shortest paths from a singularity slot to all other slots + boundary}
%\end{minipage}
%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{minipage}[b]{0.49\linewidth}
...
%----------------------------------------------------------------------------------------
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Discrete Strategy}{name=experimentation,column=1,below=pipeline, above=bottom}{
\vspace{-0.105cm}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\captionsetup{labelformat=empty}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\vspace{-0.1cm}
\begin{center}
\begin{minipage}[b]{1.0\linewidth}%\begin{flushright}
\vspace{-0.35cm}                                 
\includegraphics[width=1.0\textwidth]{HIS_collection}%\end{flushleft}
\captionof{figure}{Higher resolution $\rightarrow$ better approximation} 
%\vspace{-1.5cm}
\end{minipage}
\end{center}
%\hspace{-0.4cm}
\begin{center}
\begin{minipage}[b]{0.79\linewidth}%\begin{flushright}
\includegraphics[width=1.0\textwidth]{CWCH_coarse-shortest_paths}%\end{flushleft}
