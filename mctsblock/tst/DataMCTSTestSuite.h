...
/*----------------------------------------------------------------------------*/
void
init_geom_model(gmds::cad::FACManager &AGeomManager, const std::string& AFileName)
{
...
/*----------------------------------------------------------------------------*/
void read_blocking(gmds::Mesh &AMesh, const std::string AFileName)
{
...
/*----------------------------------------------------------------------------*/
TEST(DataMCTSTestSuite, cube){
	gmds::cad::FACManager geom_model;
	init_geom_model(geom_model, "cube.vtk");
