...
/*----------------------------------------------------------------------------*/
        ...
        public:
             ...
             *  @param AFromMesh 3D mesh used to build the model
             */
            void initAndLinkFrom3DMesh(Mesh* AFromMesh,
             ...
             */
            void initAndLinkFrom2DMesh(Mesh* AFromMesh,
                                       GeomMeshLinker* ALinker);
        ...
        private:
            ...
            bool IsInsideFace(const int&, const math::Vector3d&,
                              const math::Vector3d&, Face fi);

            math::Vector3d GetBarycentricCoefs(math::Vector3d& V1,
                                               math::Vector3d& V2,
                                               math::Vector3d& V3,
                                               math::Vector3d& I,
