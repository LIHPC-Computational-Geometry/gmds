...
namespace gmds{
    ...
    */
    ...
    public:
        ...
        RegionContainer& regions() const{ return *m_regions_container;}
        /*------------------------------------------------------------------------*/
        /** \brief Destructor
         */
        virtual ~Mesh();
         ...
         */
        inline TInt getDim() const {return m_model.getDim();}
        ...
        inline TInt getNbTetrahedra() const {return m_regions_container->m_T2N->size();}
        inline TInt getNbHexahedra() const {return m_regions_container->m_H2N->size();}
         ...
         */
        nodes_iterator nodes_begin(){return m_nodes_container->begin();}
         ...
         * \return a node iterator
         */
        nodes_iterator nodes_end(){return m_nodes_container->end();}
         ...
         */
        edges_iterator edges_begin(){return m_edges_container->begin();}
         ...
         * \return an edge iterator
         */
        edges_iterator edges_end(){return m_edges_container->end();}
        /*------------------------------------------------------------------------*/
        /** \brief Factory method to get an iterator on the first face
         *
         * \return a face iterator
         */
        faces_iterator faces_begin(){return m_faces_container->begin();}
         ...
         * \return a face iterator
         */
        faces_iterator faces_end(){return m_faces_container->end();}
        /*------------------------------------------------------------------------*/
        /** \brief Factory method to get an iterator on the first region
         *
         * \return a region iterator
         */
        regions_iterator regions_begin(){return m_regions_container->begin();}
         ...
         * \return a region iterator
         */
        regions_iterator regions_end(){return m_regions_container->end();}
         ...
         */
        template<typename T>
        CellGroup<T>* newGroup(const std::string& AName);
         ...
         */
        template<typename T>
        void deleteGroup(CellGroup<T>* ACloud);
         ...
         */
        template<typename T>
        CellGroup<T>* getGroup(const std::string& AName);
         ...
         */
        template<typename T>
        CellGroup<T>* getGroup(const unsigned int AIndex);
         ...
         */
        template<typename T>
        unsigned int getNbGroups() const;
        ...
        void getCommonNodes(const Face& AF1, const Face& AF2, std::vector<TCellID>& Avec);
        /*------------------------------------------------------------------------*/
        ...
        void getCommonFaces(const Node& AN1, const Node& AN2, std::vector<TCellID>& Avec);
         ...
         */
        Variable<cad::GeomEntity*> * getGeometricClassification(const int ADim);
    ...
    template<typename T, ECellType E>
    Variable<T>* Mesh::newVariable(const std::string& AName)
    {
        Variable<T> *v;
        std::vector<int> ids;
        switch(E){
    ...
    /*----------------------------------------------------------------------------*/
    template<typename T, ECellType E>
    Variable<T>* Mesh::getVariable(const std::string& AName) const
    {
        Variable<T> *v;
        std::vector<int> ids;
        switch(E){
    ...
    /*----------------------------------------------------------------------------*/
    template<typename T, ECellType E>
    Variable<T>* Mesh::getOrCreateVariable(const std::string& AName)
    {
        Variable<T> *v=NULL;
        try {
